...
<!-- 解释 confusion matrix和 specificity -->
...
- Apply 3-means clustering to our consolidated data
- Low-risk cluster, mid-risk cluster, and high-risk cluster
...
- Future
    ...
    - Models and techniques: artificial neural networks (restricted boltzmann machine), text mining, etc.
