...
head(fe.cmb.result %>% filter(year >= 2005) %>% arrange(desc(num.death)), 20) %>% select(
...
head(fe.div.result %>% filter(year >= 2005) %>% arrange(desc(num.death)), 20) %>% select(
  mine.name, num.death, severe, prob, pred
)
...
head(glm.result %>% filter(year >= 2005) %>% arrange(desc(num.death)), 20) %>% select(
  mine.name, num.death, severe, prob, pred
)
