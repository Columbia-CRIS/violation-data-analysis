...
Next, let's try out spectral clustering.  (TODO)
...
mean(labeled.data.lost.train$severe != predict(svm)) # misclassification rate

pred.train <- predict(svm.model, labeled.data.lost.train)
...
Now, let's try an ensemble learning method, which is a combination of random forest and SVM.
