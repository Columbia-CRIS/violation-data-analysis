...
plot(svm.model, labeled.data.lost.train)

compareTable <- table (labeled.data.lost.train$severe, predict(svm.model))  # tabulate
mean(labeled.data.lost.train$severe != predict(svm)) # false rate

pred.train <- predict(svm.model, labeled.data.lost.train)
mean(pred.train==labeled.data.lost.train$severe) # true rate
```
